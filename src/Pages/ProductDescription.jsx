    ...
    <div className="min-h-screen w-full bg-[whitesmoke] flex flex-col sm:flex-row relative">
      ...
      <div className="w-full md:w-[40%] sm:p-2 flex justify-center ">
        <img
          ...
          alt={product.title}
          className="h-[45vh] sm:h-[300px] aspect-square  w-full md:w-[400px] sm:mt-10 xl:w-[85%] sm:rounded-t-md rounded-b-xl md:rounded-xl md:shadow-lg md:shadow-slate-300 sm:sticky sm:top-10"
        />
      </div>
